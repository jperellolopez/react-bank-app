    ...
    {/* Logo and links */}
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        <div className='flex flex-1 flex-col justify-start mr-10'>
          ...
          <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>Un nuevo método para hacer los pagos fáciles, fiables y seguros</p>
        </div>
      ...
      <div className='w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45] '>
        <p className='font-poppins font-normal text-center text-[18px] leading-[27px] text-white'>2022 bank-app. All Rights Reserved</p>
